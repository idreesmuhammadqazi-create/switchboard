 ...
 *   1. A drifting radial-gradient blob (CSS keyframes), tinted lime.
 *   2. A vertical "scanline" gradient that moves down forever.
 *   3. A faint grid mask that anchors the page visually.
 *
...
export function AmbientLayer() {
  return (
    ...
    >
      ...
      {/* Layer 3 — vertical scan gradient that scrolls down forever */}
      <div
      ...
      {/* Layer 4 — faint grid mask. Anchors the page so it never feels empty. */}
      <div
      ...
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce) {
          .ambient-blob, .ambient-blob-2, .ambient-scan {
            animation: none;
          }
        }
      `}</style>
